...
divergences agree. Nothing in the arc is open here until the next construct
is started, and it arrives the way every entry does, with what breaks
without it written down first.
